...
enum class ResultCode : unsigned char {
    ...
    /** The volume size is outside the accepted range. */
    USER_ERROR_ILLEGAL_VOLUME_SIZE = 0x98,
    /** The chunk size was changed after the writer was initialized. */
    USER_ERROR_SETTING_VOLUME_SIZE_AFTER_INIT = 0x99,
...
#define VXIO_REGISTER_RESULT_CODE(value) result[static_cast<usize>(ResultCode::value)] = #value
    ...
    VXIO_REGISTER_RESULT_CODE(USER_ERROR_ILLEGAL_VOLUME_SIZE);
    VXIO_REGISTER_RESULT_CODE(USER_ERROR_SETTING_VOLUME_SIZE_AFTER_INIT);
